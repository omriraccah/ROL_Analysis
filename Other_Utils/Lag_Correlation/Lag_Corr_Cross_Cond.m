function [ATbT_Correlation_Values,lags] = Lag_Corr_Cross_Cond(fname,indchan,conds,timewin, save,suffix,colors,labels)
...
[MXCF,lags,bounds] = crosscorr(chan1_mcond,chan2_mcond,700);
...
hold on
   ...
   lineHandles = stem(bin_lags,bin_MXCF);
   %lineHandles(1).Color = ;
