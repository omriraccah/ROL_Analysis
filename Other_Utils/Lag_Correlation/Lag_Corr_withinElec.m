function [ATbT_Correlation_Values,bin_lags] = Lag_Corr_withinElec(fname,indchan,conds,timewin, save,suffix,colors,labels)
...
[ATbT_Correlation_Values,lags,bounds] = crosscorr(chan1_mcond,chan2_mcond,1500);
...
% hold on
% 
%    lineHandles = bar(bin_lags,bin_MXCF,'FaceColor',[0.768627450980392,0.192156862745098,0.192156862745098],'FaceAlpha',0.1);
%    %lineHandles(1).Color = ;
...
% 
% ATbT_Correlation_Values = bin_MXCF;
% 
%   
%    
% %  Plot the confidence bounds (horizontal lines) under the hypothesis that
