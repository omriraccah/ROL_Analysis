function Plot_Average_Signal_TrialError(fname,indchan,conds,timewin, save,prefix,colors,labels)
...
% -------------------------------------------------------------------------
% Written by O. Raccah, LBCN, Stanford, 10/28/2015
...
for i=1:length(indchan)
    ...
    for sp = 1:length(labs) 
        ...
        for tr = 1:length(tr_toplot)
            ...
            plot(tim(idt), trial_Data,'Color', [0.7,0.7,0.7],'LineWidth',3)
