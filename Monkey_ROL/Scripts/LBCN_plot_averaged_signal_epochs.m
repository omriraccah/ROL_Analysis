function LBCN_plot_averaged_signal_epochs(fname,indchan,conds,timewin, save,prefix,colors,labels)
...
for i=1:length(indchan)
    ...
    if save
        ...
        print('-opengl','-r300','-dpng',strcat([path,filesep,'figs_8',filesep,prefix,'Signal_conditions_',char(chanlabels(D,indchan(i)))]));
        delete(hfig)
    end
